...
index_dir_path="../../data/indexes/AP_ANCE_512_Faiss_index"
...
bm25_b=0.4
top_k=1000
metrics="map,ndcg_cut.5,ndcg_cut.10,P.5,P.10,recall.100,recall.1000"
...
# List of all prompt types for pseduo_narrative query_type
 pseduo_narrative_prompt_types=("few_shot_narrative_prompt" "complex_few_shot_narrative_prompt" "few_shot_pseudo_narrative_only_prompt" "complex_few_shot_pseudo_narrative_only_prompt")
