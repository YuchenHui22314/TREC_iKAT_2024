...
#### modify query types and retrieval reranking model. 
...
given_ranking_list_path="/data/rech/huiyuche/TREC_iKAT_2023/results/ClueWeb_ikat/ikat_23_test/ranking/S1[gpt-4o_rar_rw_fuse_rar_rwrs_fuse_personalized_cot1_rw]-S2[none]-g[none]-[none]-[none_4_1_none]-[s2_top50].txt"
# project specific
run_name="none"
# raw_llm_rm_PDCReORf
...
#retrieval_query_types=("gpt-4o_rar_rw" " gpt-4o_rar_rwrs" "gpt-4o_rar_rw_fuse_rar_rwrs" "gpt-4o_rar_rw_fuse_rar_personalized_cot1_rw" "gpt-4o_rar_rw_fuse_rar_rwrs_fuse_personalized_cot1_rw" ) 
retrieval_query_types=("gpt-4o_rar_personalized_cot1_rw") 
