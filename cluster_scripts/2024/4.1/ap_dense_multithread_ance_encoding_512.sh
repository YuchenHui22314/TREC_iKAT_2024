...
LOG=/home/yuchenxi/projects/def-jynie/yuchenxi/IR_LLM_user_intent_alignment/cluster_scripts/temp_logs/log.txt
...
# move to the folder containing the scripts
cd /home/yuchenxi/projects/def-jynie/yuchenxi/IR_LLM_user_intent_alignment/src/indexing
# pip list
chmod +x *.sh

# run the script
echo "beginning encoding"
./dense_ance_encoding.sh 4 ../../data/collections/AP_jsonl ../../data/indexes/AP_ANCE_512_embeddings ${LOG} &
